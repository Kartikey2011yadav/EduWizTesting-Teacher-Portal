...
const TeacherNavbar = (props) => {
  return (
    <div
      ...
      className="TEACHER_NAVBAR flex flex-row justify-between items-center w-full h-[60px] bg-[#0369a1] dark:bg-[#1C2434] px-10"
    >
      ...
      <div className=" w-max h-full relative flex flex-row gap-3 items-center ">
        <div className=" relative flex rounded-full my-2 w-[45px] h-[45px] bg-slate-400 overflow-clip">
          <img
            src={props.img ? props.img : defaultUserPhoto}
            alt="profile pic"
            height={'45px'}
