    ...
    return (
        <div className='TEST_CARD relative w-full flex flex-col gap-1'>
            ...
            <div className=' TEST_CARD_BUTTONS relative flex justify-end gap-2 text-white font-thin'>
                <button className='TEST_CARD_BUTTON_EDDIT bg-[#1E293B] rounded-md px-3 py-1 flex items-center gap-1'><FaEdit /> Eddit</button>
                <button className='TEST_CARD_BUTTON_DUPLICATE bg-[#1E293B] rounded-md px-3 py-1 flex items-center gap-1'><FaCopy /> Duplicate</button>
                <button className='TEST_CARD_BUTTON_DELETE bg-[#FF2121] rounded-md px-3 py-1 flex items-center gap-1'><FaTrash /> Delete</button>
            </div>
            {/* main content */}
            <div className='TEST_CARD_BOX relative flex justify-between px-6 py-3 w-full rounded-md border-l-4 border-[#0EA5E9] bg-[#F1F5F9]'>
                ...
                <div className="TEST_CARD_DETAILS relative flex flex-col">
                    <p className='TEST_CARD_DETAILS_COURSE text-[#1E293B] font-bold text-[20px]'>Course Name: {props.test.course}</p>
